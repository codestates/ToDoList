...
module.exports = (req, res) => {
    ...
    // 나눠야할 필드 : 시간 & 시계의 시각
    const {userId, list, startTime, endTime, startTime_feedback, endTime_feedback, theme, date} = req.body;
    ...
    if (!userId && !list && !startTime && !endTime && !date) {
        ...
        // 그게 아니면 데이터 저장하기
        NotToDoList.create({userId, list, startTime, endTime, startTime_feedback, endTime_feedback, theme, date})
        .then((data)=> {
